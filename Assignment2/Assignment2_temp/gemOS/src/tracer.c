...
// void initialise_syscall_params() {
// 	param_numbers[SYSCALL_EXIT] = 0;
// 	param_numbers[SYSCALL_GETPID] = 0;
// 	param_numbers[SYSCALL_GETPPID] = 0;
// 	param_numbers[SYSCALL_FORK] = 0;
// 	param_numbers[SYSCALL_CFORK] = 0;
// 	param_numbers[SYSCALL_VFORK] = 0;
// 	param_numbers[SYSCALL_PHYS_INFO] = 0;
// 	param_numbers[SYSCALL_STATS] = 0;
// 	param_numbers[SYSCALL_GET_USER_P] = 0;
// 	param_numbers[SYSCALL_GET_COW_F] = 0;
// 	param_numbers[SYSCALL_CONFIGURE] = 1;
// 	param_numbers[SYSCALL_DUMP_PTT] = 1;
// 	param_numbers[SYSCALL_SIGNAL] = 1;
// 	param_numbers[SYSCALL_SLEEP] = 1;
// 	param_numbers[SYSCALL_EXPAND] = 2;
// 	param_numbers[SYSCALL_CLONE] = 2;
// 	param_numbers[SYSCALL_MMAP] = 4;
// 	param_numbers[SYSCALL_MUNMAP] = 2;
// 	param_numbers[SYSCALL_MPROTECT] = 3;
// 	param_numbers[SYSCALL_PMAP] = 1;
// 	param_numbers[SYSCALL_PMAP] = 1;
// 	// param_numbers[SYSCALL_OPEN] = 1; How to deal with open which have multiple implementation
// 	param_numbers[SYSCALL_OPEN] = 3;
// 	param_numbers[SYSCALL_READ] = 3;
// 	param_numbers[SYSCALL_WRITE] = 3;
// 	param_numbers[SYSCALL_DUP] = 1;
// 	param_numbers[SYSCALL_DUP2] = 2;
// 	param_numbers[SYSCALL_DUP2] = 2;
// 	param_numbers[SYSCALL_CLOSE] = 1;
// 	param_numbers[SYSCALL_LSEEK] = 3;
// 	param_numbers[SYSCALL_FTRACE] = 4;
// 	param_numbers[SYSCALL_TRACE_BUFFER] = 1;
// 	param_numbers[SYSCALL_START_STRACE] = 2;
// 	param_numbers[SYSCALL_END_STRACE] = 0;
// 	param_numbers[SYSCALL_READ_STRACE] = 3;
// 	param_numbers[SYSCALL_READ_FTRACE] = 3;
// 	param_numbers[SYSCALL_STRACE] = 2;
...
// 	if(strace_buf->size < BYTES_WRITTEN(param_numbers[syscall_num])) {
// 		return -EINVAL;
// 	}
// 	u64 *start = (u64*)(strace_buf->trace_buffer+strace_buf->write);
// 	*start = syscall_num;
// 	if(param_numbers[syscall_num] >= 1) {
// 		*(start + 1) = param1;
// 	}
// 	if(param_numbers[syscall_num] >= 2) {
// 		*(start + 2) = param2;
// 	}
// 	if(param_numbers[syscall_num] >= 3) {
// 		*(start + 3) = param3;
// 	}
// 	if(param_numbers[syscall_num] >= 4) {
// 		*(start + 4) = param4;
// 	}
// 	strace_buf->write = (strace_buf->write + BYTES_WRITTEN(param_numbers[syscall_num])) % TRACE_BUFFER_MAX_SIZE;
// 	strace_buf->size = strace_buf->size - BYTES_WRITTEN(param_numbers[syscall_num]);
// 	return BYTES_WRITTEN(param_numbers[syscall_num]);
}
...
// 		if(bytes_written != 8*(param_numbers[syscall_num] + 1)) {
// 			return -EINVAL;
// 		}
// 	}
